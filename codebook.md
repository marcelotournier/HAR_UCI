...
Group - Identifies the group where the volunteers belonged:
	train - training group
	test - test group

activity - Shows the activity name:
	WALKING
	WALKING_UPSTAIRS
	WALKING_DOWNSTAIRS
	SITTING
...
### Continuous variables - Feature Selection 
...
##Data code book - dataset "uci_means"
...
The set of variables that were estimated from these signals are from the Mean values of the observations from each subject, derived from dataset "uci".